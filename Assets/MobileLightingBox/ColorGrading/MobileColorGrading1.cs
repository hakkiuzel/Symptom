...
public class MobileColorGrading1 : MonoBehaviour {

	[Header("Tone Mapping")]
	// Tonemapping type - ACES Filmic or None
	public ToneMapping1 toneMapping = ToneMapping1.ACES;
