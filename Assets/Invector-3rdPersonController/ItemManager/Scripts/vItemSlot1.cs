...
namespace Invector.vItemManager
{
    ...
    public delegate void ItemSlotEvent1(vItemSlot1 item);
    public class vItemSlot1 : MonoBehaviour, IPointerClickHandler, ISelectHandler, IDeselectHandler, ISubmitHandler, IPointerEnterHandler, IPointerExitHandler
    {       
        public Image icon;
        ...
        public ItemSlotEvent1 onSubmitSlotCallBack, onSelectSlotCallBack, onDeselectSlotCallBack;
